...
from app.core.decorators import admin_required, operador_required, equipe_clinica_required
...
def novo_medico():
    ...
    try:
        medico = Medico(nome=nome, crm=crm, especialidade=especialidade, contato=contato)
